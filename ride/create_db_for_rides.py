...
c.execute('''CREATE TABLE ride(
            ride_id INTEGER PRIMARY KEY AUTOINCREMENT,created_by VARCHAR(50) NOT NULL, timestamp VARCHAR(19) NOT NULL,source INTEGER NOT NULL,destination INTEGER NOT NULL)''')

c.execute('''CREATE TABLE join_ride(   
            ride_id INTEGER(5),username VARCHAR(50))''')
